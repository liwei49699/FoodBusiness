...
public class RecordedActivity extends BaseActivity {
    ...
    public static final float MAX_VIDEO_TIME = 5f*1000;  //最大录制时间
    public static final float MIN_VIDEO_TIME = 1;  //最小录制时间
...
//                diyReStart = false;
    ...
    private boolean diyReStart = true;
    /**
     * 初始化视频拍摄状态
     */
